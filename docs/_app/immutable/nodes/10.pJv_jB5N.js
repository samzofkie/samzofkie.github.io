import{s as Ue,n as se}from"../chunks/scheduler.Cs0xm5t1.js";import{S as je,i as Re,e as r,s as o,H as ae,c as a,k as s,f as n,a as m,n as oe,d as t,g as l,h as ne}from"../chunks/index.Cky_bo-2.js";import{h as Se}from"../chunks/utils.BrNTHlFF.js";function Qe(he){let h,me="Binary Search Trees",q,f,fe="Basic operations for a <b>complete</b> <b>binary search tree</b> take <math>O(log n)</math> time, worst-case: however, if the tree is just a chain of nodes (effectively a linked list), the same basic operations take <math>O(n)</math> time worst-case.",B,p,pe="Nodes in a BST have four properties:",D,M,P,U,Ie=`struct Node {
  struct Node* parent;
  struct Node* left;
  struct Node* right;
  int key;
