import{s as pe,n as B}from"../chunks/scheduler.Cs0xm5t1.js";import{S as me,i as fe,e as h,s as r,H as F,c as l,k as s,f as n,a as T,n as K,d as t,g as i,h as N}from"../chunks/index.Cky_bo-2.js";import{h as _e}from"../chunks/utils.BJnaAM-2.js";function ue(Q){let o,U="Heaps",M,p,W="A <b>heap</b> is an array that is interpreted as a nearly complete binary tree: for a heap <math>H</math>, <math>H[0]</math> is the root of tree, <math>H[1]</math> is the left child of root, <math>H[2]</math> is the right child of the root, <math>H[3]</math> is the left child of the left child of the root, and so on and so forth for the size of the array.",E,y,g,P,ne=`struct Heap {
  int size;
  int array[HEAP_SIZE];
}
